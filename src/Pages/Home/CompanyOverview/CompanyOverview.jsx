  ...
  return (
    <section className="">
      ...
      <div className="container mx-auto px-6 md:px-12 text-center">
        <h2 className="text-5xl font-extrabold mb-10 text-black">
          About Us
        </h2>
        <p className="text-xl mb-8 max-w-3xl mx-auto">
          Welcome to{" "}
          <span className="font-semibold text-yellow-300">Motor Parts Co.</span>{" "}
          – your trusted partner in high-quality motor parts manufacturing. With
          decades of experience in the industry, we pride ourselves on
        ...
        <p className="text-xl mb-12 max-w-3xl mx-auto">
          ...
          automotive industry. That’s why our comprehensive range of motor parts
          is designed to meet the diverse needs of our clients, from small-scale
          workshops to large industrial enterprises.
        </p>
        <div className="flex flex-wrap justify-center">
          <div className="w-full md:w-1/3 p-6">
            <div className="bg-white rounded-lg shadow-lg p-8 text-blue-800">
          ...
          <div className="w-full md:w-1/3 p-6">
            <div className="bg-white rounded-lg shadow-lg p-8 text-blue-800">
              ...
              <p className="text-lg">
                To be the global leader in motor parts manufacturing, recognized
                for our quality, innovation, and commitment to excellence.
              </p>
            </div>
          </div>
          <div className="w-full md:w-1/3 p-6">
