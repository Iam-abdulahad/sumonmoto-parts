                ...
                <div className="card h-fit max-w-6xl p-5 md:p-12" id="form">
                    ...
                    <form id="contactForm">
                        ...
                        <div className="text-center">
                            <button type="submit" className="w-full bg-blue-800 text-white px-6 py-3 font-xl rounded-md sm:mb-0 transition duration-300 transform hover:scale-105">Send Message</button>
                        </div>
                    </form>
                </div>
            </div>
