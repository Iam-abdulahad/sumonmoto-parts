...
const Login = () => {
    ...
    return (
        <div className="w-full max-w-sm p-6 my-8 m-auto mx-auto bg-white rounded-lg shadow-md dark:bg-gray-800">
            ...
            <p className="mt-8 text-xs font-light text-center text-gray-400">Don't have an account? <Link to="/sign_up" className="font-medium text-gray-700 dark:text-gray-200 hover:underline">Create One</Link></p>
        </div>
    );
};
